...
import { selectOrder, setStateByName, putOrderSlip } from "@/redux/reducer/order/orderSlice";
import { selectCarDetails } from "@/redux/reducer/car/carDetailsSlice";

import { selectUser } from "../../../redux/reducer/auth/loginSlice";        // tambahan import untuk select User
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      setImage({
        ...
        name: result.assets[0].fileName == null? "gambar.jpg" : result.assets[0].fileName,
